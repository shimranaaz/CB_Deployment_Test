...
export const getAllTerms = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const initializeTerms = async (req: Request, res: Response): Promise<void> => {
  try {
    const defaultTerms = [
      {
...
- Your feedback helps us make our AI more helpful and ethical`,
    ...
    const promises = defaultTerms.map((term) =>
