...
export const uploadAndAnalyzeResume = async (req, res) => {
    try {
        ...
        const prepareFeedback = (report, overallScore) => {
            const strengths = [];
            const improvements = [];
            const suggestions = [];
        ...
        console.log('📈 Analysis Statistics:', {
            ...
            lowestSection: Math.min(analysis.detailedReport.keywordsMatch.score, analysis.detailedReport.skillsSection.score, analysis.detailedReport.experienceRelevance.score, analysis.detailedReport.educationCertifications.score, analysis.detailedReport.resumeFormatting.score, analysis.detailedReport.projectsAchievements.score),
            highestSection: Math.max(analysis.detailedReport.keywordsMatch.score, analysis.detailedReport.skillsSection.score, analysis.detailedReport.experienceRelevance.score, analysis.detailedReport.educationCertifications.score, analysis.detailedReport.resumeFormatting.score, analysis.detailedReport.projectsAchievements.score)
        });
...
export const getAllATSRecords = async (req, res) => {
    try {
...
export const deleteATSRecord = async (req, res) => {
    try {
        const { id } = req.params;
