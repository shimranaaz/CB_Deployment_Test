...
const ModernTemplate: React.FC<ModernTemplateProps> = ({ data, accentColor }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white text-gray-800">
      {/* Header */}
      <header className="p-8 text-white print:text-white" style={{ backgroundColor: accentColor, WebkitPrintColorAdjust: 'exact', colorAdjust: 'exact', printColorAdjust: 'exact' }}>
              ...
              <div className="flex flex-wrap gap-2">
                {data.skills.map((skill, index) => (
                  <span
                    ...
                    style={{ backgroundColor: accentColor, WebkitPrintColorAdjust: 'exact', colorAdjust: 'exact', printColorAdjust: 'exact' }}
                  >
                    {skill}
                  </span>
                ))}
