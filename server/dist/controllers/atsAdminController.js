...
export const getAllATSSubmissions = async (req, res) => {
    try {
...
export const deleteATSSubmission = async (req, res) => {
    try {
        const { id } = req.params;
...
export const getATSStats = async (req, res) => {
    try {
...
export const getATSSubmissionById = async (req, res) => {
    try {
        const { id } = req.params;
        const submission = await ATS.findById(id);
        if (!submission) {
