...
const NetworkingPromo: React.FC = () => {
  return (
    <div
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-16 right-1/3 text-2xl font-light"
          style={{ color: "#2c2a63", opacity: 0.3 }}
        >
          +
        </div>
        <div
          className="absolute bottom-1/3 left-1/4 text-3xl font-light"
          style={{ color: "#2c2a63", opacity: 0.25 }}
        >
          ×
        </div>
      </div>
      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center relative z-10 mt-16 sm:mt-0">
        ...
        <div className="space-y-6 text-center md:text-left px-2">
          ...
          <p
            ...
            style={{ color: "#2c2a63" }}
          >
            Build meaningful connections, grow your professional network, and
            unlock new career opportunities. Launching soon!
          </p>
        </div>
...
export default NetworkingPromo;
